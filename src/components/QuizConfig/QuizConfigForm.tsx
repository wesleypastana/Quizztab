...
export function QuizConfigForm({ config, onConfigChange }: QuizConfigFormProps) {
  ...
  return (
    <div className="quiz-config-form">
      {/* Seção: Configurações do Quiz */}
      <div className="config-group">
        <h3 className="config-group-title">Configurações do Quiz</h3>
      ...
      {/* Seção: Timer */}
      <div className="config-group">
        <h3 className="config-group-title">Timer</h3>
        <TimerConfig
      ...
      {/* Seção: Vídeo */}
      <div className="config-group">
        <h3 className="config-group-title">Configurações de Vídeo</h3>
        <div className="config-grid">
          <div className="config-section">
            <label>
